...
- `--diffusion-model`: Diffusion model id (default `black-forest-labs/FLUX.1-dev-onnx`).
...
- The default FLUX diffusion model (`black-forest-labs/FLUX.1-dev-onnx`) uses the ONNX export published by Black Forest Labs.
