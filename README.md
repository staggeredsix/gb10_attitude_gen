...
- `--diffusion-model`: Diffusion model id (default `black-forest-labs/FLUX.1-dev-fp4`).
...
- The default FLUX diffusion model (`black-forest-labs/FLUX.1-dev-fp4`) ships an FP4 quantization config for the transformer to keep GPU memory and bandwidth in check.
