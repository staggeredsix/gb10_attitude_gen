...
class AppConfig:
    ...
    diffusion_model: str = "black-forest-labs/FLUX.1-Turbo"
...
def load_config(args: argparse.Namespace) -> AppConfig:
    ...
    diffusion_model = args.diffusion_model if args.diffusion_model else env_diffusion_model or "black-forest-labs/FLUX.1-Turbo"
